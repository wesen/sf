...
Proof.
  intros X l1.
  induction l1 as [| h t].
  intros l2 v. reflexivity.
  intros l2 v. simpl. rewrite IHt. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros X Y Z f p.
  unfold prod_uncurry. unfold prod_curry. destruct p. reflexivity.
Qed.
(** [] *)
...
Proof.
  unfold filter_even_gt7. unfold filter. simpl.
  reflexivity.
Qed.
...
Proof.
  intros b. unfold override. unfold constfun. reflexivity.
Qed.
(** [] *)
...
Proof.
  unfold zero. unfold one. unfold succ. reflexivity.
Qed.

Example succ_2 : succ one = two.
Proof.
  unfold two. unfold one. unfold succ. reflexivity.
Qed.

Example succ_3 : succ two = three.
Proof.
  unfold two. unfold three.
  unfold succ. unfold doit3times. reflexivity.
  Qed.
...
Proof. unfold plus. unfold three. unfold two.
       unfold doit3times. reflexivity.
       Qed.
